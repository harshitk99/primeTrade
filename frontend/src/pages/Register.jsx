                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-600 focus:border-transparent transition-all outline-none bg-white"
                            >
                                <option value="user">User (Create only their own)</option>
                                <option value="mod">Moderator (See all, manage own)</option>
